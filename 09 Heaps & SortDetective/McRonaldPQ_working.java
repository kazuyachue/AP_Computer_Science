...
public class McRonaldPQ_working
{
   public static void main(String[] args)
   {
     ...
     // PriorityQueue<Student> heap  = new PriorityQueue<>();
      HeapPriorityQueue<Student> heap = new HeapPriorityQueue<>();
     /*--implement the PriorityQueue API in your HeapPriorityQueue so that these all work ----------*/
      System.out.println( heap.peek() );                 //null
      boolean added = heap.add(new Student(20, "1900"));
      System.out.println( heap.peek() );                 //20 1900     
      System.out.println( heap.remove() );               //20 1900
